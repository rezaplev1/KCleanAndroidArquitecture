...
/**
 * Following this article I realize that I could create a similar solution which reduce boilerplate code and reuse the observer
    ...
    override fun onChanged(t: Result<T>?) {
        if (t != null && (!oneShot || !hasBeenHandled)) {
            when {
                ...
                t.isFailure() -> failure(t.getExceptionOrNull())
            }
            hasBeenHandled = true
        }
    }
